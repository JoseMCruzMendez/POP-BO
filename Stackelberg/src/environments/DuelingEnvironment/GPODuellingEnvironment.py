...
class GPODuellingEnv(UtilityDuellingEnv):
    ...
    def _calculate_prob(
        ...
        #Model was trained on min instead of max so flip the sign of the score to get sigmoid(score)=1-p instead of p
    ...
    def regret(
        ...
        #     return self._calculate_prob(params.best_arm, single_arm, params) - self._calculate_prob(params.best_arm, params.best_arm, params)
